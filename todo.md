...
- [x] Report backup readiness and any remaining differences from Manus hosting
...
- [ ] Verify and resolve the reported mismatch where the deployed About page still shows the old Team section
