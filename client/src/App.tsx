...
function InteractiveHeroVisual({ lang }: { lang: Lang }) {
  return <div className="hero-visual hero-composed" data-hero-version="energy-light-pulse-v1" aria-label={lang === "ar" ? "زجاجة بلاستيك وعلبة صفيح وزجاجة زجاج وكرتون ومخلفات عضوية حول مركز الطاقة" : "Plastic bottle, tin can, glass bottle, cardboard, and organic waste around an energy center"}>
    ...
    <div className="interactive-material-orbit" role="img" aria-label={lang === "ar" ? "زجاجة بلاستيك وعلبة صفيح وزجاجة زجاج وكرتون ومخلفات عضوية تتحرك حول مركز طاقة" : "Plastic bottle, tin can, glass bottle, cardboard, and organic waste moving around an energy core"}>
      <span className="energy-ring energy-ring-outer" /><span className="energy-ring energy-ring-middle" /><span className="energy-ring energy-ring-inner" /><span className="energy-wave energy-wave-one" /><span className="energy-wave energy-wave-two" /><span className="energy-beam" />
