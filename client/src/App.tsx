...
function InteractiveHeroVisual({ lang }: { lang: Lang }) {
  return <div className="hero-visual hero-composed" data-hero-version="realistic-material-cutouts-v2" aria-label={lang === "ar" ? "زجاجة بلاستيك وعلبة صفيح وزجاجة زجاج وكرتون ومخلفات عضوية حول مركز الطاقة" : "Plastic bottle, tin can, glass bottle, cardboard, and organic waste around an energy center"}>
    ...
    <div className="interactive-material-orbit" role="img" aria-label={lang === "ar" ? "زجاجة بلاستيك وعلبة صفيح وزجاجة زجاج وكرتون ومخلفات عضوية تتحرك حول مركز طاقة" : "Plastic bottle, tin can, glass bottle, cardboard, and organic waste moving around an energy core"}>
      ...
      <span className="material-object material-bottle"><img src="/manus-storage/enercyra-plastic-bottle-realistic_7ffa8869.png" alt="" aria-hidden="true" /></span><span className="material-object material-can"><img src="/manus-storage/enercyra-can-realistic_212d5203.png" alt="" aria-hidden="true" /></span><span className="material-object material-glass"><img src="/manus-storage/enercyra-glass-bottle-realistic_f5fad6c5.png" alt="" aria-hidden="true" /></span><span className="material-object material-cardboard"><img src="/manus-storage/enercyra-cardboard-realistic_895aaadd.png" alt="" aria-hidden="true" /></span><span className="material-object material-organic"><img src="/manus-storage/enercyra-organic-realistic_9c545ca2.png" alt="" aria-hidden="true" /></span>
